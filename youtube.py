...
#API key connection
Api_Id="AIzaSyAbLlHnYetC2QilKpTrh19erxjnDt2qPXY"
...
def get_channel_info(channel_id):
    ...
    for i in range(0,len(response1["items"])):
        data = dict(
                    ...
                    Upload_Id = response1["items"][i]["contentDetails"]["relatedPlaylists"]["uploads"]
                    )
        return data
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://manjula:BigBoss1@cluster5.nhmrnql.mongodb.net/?retryWrites=true&w=majority")
...
def channels_table():
    ...
    try:
        ...
        st.write("Channels Table already exists")    
